...
public class UnbrokenWallMaze extends JFrame implements KeyListener {
    ...
    JButton TorchCount = new JButton();
    ...
    JButton[] Tab = new JButton[6]; // Different Types of PowerUp's
    ...
    UnbrokenWallMaze() {
        ...
        while (UnbrokenWallMaze.MoveTest(0,0) < Size * Size) {
            //for (int a = 0; a < 10; a ++) {
            Past.clear();
            int Space = UnbrokenWallMaze.MoveTest(0, 0);
            ...
            while (TryAgain) {
                ...
                if (Rando == 0 && Rand0) {
                    if (MoveUp[Cords[0]][Cords[1]]) {
                        ...
                        if (UnbrokenWallMaze.MoveTest(0, 0) > Space) {
        ...
        for (int x = 0; x < PowerUp.length; x++) {
            ...
            PowerUpStats[x] = (int) (Math.random() * Tab.length);
            PowerUp[x].setOpaque(true);
            switch (PowerUpStats[x]) {
                case 0: {
                    PowerUp[x].setBackground(Color.MAGENTA);
                    break;
                }
                case 1: {
                    PowerUp[x].setBackground(Color.PINK);
                    break;
                }
                case 2: {
                    PowerUp[x].setBackground(Color.GREEN);
                    break;
                }
                case 3: {
                    PowerUp[x].setBackground(Color.CYAN);
                    break;
                }
                case 4: {
                    PowerUp[x].setBackground(Color.BLUE);
                    break;
                }
                case 5 : {
                    PowerUp[x].setBackground(Color.red);
                    break;
                }
            }
        ...
        TorchCount.setBackground(Color.yellow);
        TorchCount.setBounds((Size * 35) + 30, 20, 200, 50);
        TorchCount.setText("Torch Count: " + TorchLimit);
        TorchCount.setOpaque(true);
        TorchCount.addActionListener(e -> Player.setLocation((int) (Math.random() * Size) * 35, (int) (Math.random() * Size) * 35));
    ...
    public static void main(String[] args) {
        UnbrokenWallMaze run = new UnbrokenWallMaze();
    }
...
//                        System.out.println("\nEnemy " + d);
                        ...
                        if (d % 2 == 0) {
                            Repeat = (xChange + yChange > Sight + 2 && xTorch + yTorch > TorchSight + 2);
                            ExtraRepeat = (xChange + yChange > Sight + 4 && xTorch + yTorch > TorchSight + 4);
                            MegaRepeat = (xChange + yChange > Sight + 7 && xTorch + yTorch > TorchSight + 7);
                        }
                        for (int r = 0; r < 3; r++) {
                            if (Wonder) {
                                Wonder = false;
...
//                    System.out.println("Right: " + toString(SoundPast) + " " + Turns);
    ...
    public void NewPowerUp(int Pos) {
        ...
        PowerUpStats[Pos] = (int) (Math.random() * Tab.length);
